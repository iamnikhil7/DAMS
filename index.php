...
<div class="booking-form shadow-lg p-4 rounded-4 bg-white">
  <h3 class="section-heading text-center mb-3" style="font-family:'Poppins', sans-serif; font-weight:600;">
    Book an Appointment
  </h3>
  <p class="text-center text-muted mb-4">
    Fill in the form below. Appointments will get an appointment number and a confirmation page.
  </p>
