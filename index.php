                            ...
                            <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="images/slider/Sukraraj_Tropical_and_Infectious_Disease_Hospital__STIDH1618490030_1024.jpg" class="img-fluid" alt="">
                                    </div>
                            ...
                            <div class="booking-form">
                                ...
                                <form role="form" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <input type="number" name="phone" id="phone" class="form-control" placeholder="Enter Phone Number" maxlength="10">
                                        </div>
