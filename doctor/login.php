...
<body class="simple-page">
	<div id="back-to-home">
		<a href="../index.php" class="btn btn-outline btn-default">Home</i></a>
	</div>
	...
	<h4 class="form-title m-b-xl text-center" style="color: white" >Login</h4>
	...
	<hr />
	<a href="signup.php"style="color: white">Signup/Registration</a>
	<br>
</div><!-- #login-form -->
