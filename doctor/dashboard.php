...
?>
						<div class="pull-left">
							...
							<small style="color:red">Total New Appointment</small>
						</div>
					</div>
					<footer class="">
						<a href="new-appointment.php"><small> View Detail</small></a>
						<span class="small-chart pull-right" data-plugin="sparkline" data-options="[4,3,5,2,1], { type: 'bar', barColor: '', barWidth: 5, barSpacing: 2 }"></span>
					</footer>
				</div><!-- .widget -->
			</div>
...
?>
						<div class="pull-left">
							...
							<small style="color:red">Total Approved</small>
						</div>
...
?>
							...
							<small style="color:red">Cancelled Appointment</small>
						</div>
					</div>
					<footer class="">
...
?>
							...
							<small style="color:red">Total Appointment</small>
						</div>
					</div>
					<footer class="">
