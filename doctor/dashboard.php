...
<head>
    ...
    <style>
        ...
        .app-header a:hover {
            color: #ffec99;
            text-shadow: 0 0 8px rgba(255, 255, 153, 0.7);
        }
                ...
                <div class="widget stats-widget">
                    <div class="widget-body clearfix">
                        <div class="pull-left">
                            ...
                            <small>Total New Appointment</small>
                        </div>
                    </div>
                    <footer>
                ...
                <div class="widget stats-widget" style="background: linear-gradient(135deg,#0077b6,#90e0ef);">
                    <div class="widget-body clearfix">
                        <div class="pull-left">
                            ...
                            <small>Cancelled Appointment</small>
                        </div>
                    </div>
                    <footer>
