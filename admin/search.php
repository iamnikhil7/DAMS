...
<head>
    ...
    <style>
        body.menubar-left {
            background: linear-gradient(120deg, #11998e, #38ef7d, #11998e);
        ...
        .app-header a:hover { color:#ffd700; text-shadow: 0 0 8px rgba(255,215,0,0.7); }
        ...
        .widget-header h4, .widget-header form label {
            font-weight: 700;
            color: #fff;
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget">
                        ...
                        ?>
                        <h4 align="center" style="color:#fff;">Search Results for "<?php echo htmlentities($sdata);?>"</h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                                    ...
                                    <tbody>
                                        ...
                                        $sql="SELECT * from tblappointment where (AppointmentNumber like '$sdata%' OR Name like '$sdata%' OR MobileNumber like '$sdata%') AND Doctor=:docid";
                                        ...
                                        <?php $cnt++; } } else { ?>
                                        <tr>
                                            <td colspan="7" style="text-align:center; color:#fff;">No record found against this search</td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                    <tfoot>
